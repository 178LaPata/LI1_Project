...
Security
Insights
grupo110/src/Tarefa5.hs
@jotaalvim
jotaalvim mudanças no alg
Latest commit de901da 2 days ago
 History
 1 contributor
218 lines (165 sloc)  6.87 KB
...
cmcl (x,y) m = (snd $ last lf)
    where
        ...
        yfR   = _mov y ( 1) lar
        lar = length $ head m
        lf =  sortOn fst [ (d,o) |  (d,o)<- [pecaU,pecaD,pecaR,pecaL], d < (cm m )] 
