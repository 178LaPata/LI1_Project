...
-- ghci f < teste.hss
--este ficheiro recebe o teste como input
-- labirinto sample
...
--------------------------------------------------------------------------------------------
-- poe os pontos nos is, pega no ef do stor epoe os id "corretos"
popni :: State -> State
